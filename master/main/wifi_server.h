...
#define WIFI_DEVICE_ID            "master1"         //第一套主机改为 master1；两台主机 ID 必须不同
#define WIFI_NODE_ROLE            "MASTER"          //上位机显示的设备角色
...
/* Send a worker result with an explicit destination and correlation ID. */
