...
class RS485BusFramingTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls._temporary = tempfile.TemporaryDirectory(prefix="rs485_bus_", dir=ROOT / "tests")
        ...
        if os.name != "nt":
            command += ["-fPIC"]
        command += ["-I", str(ROOT / "tests/firmware/rs485_bus_stubs"),
                    str(ROOT / "tests/firmware/rs485_bus_test.c"), "-o", str(output)]
        try:
