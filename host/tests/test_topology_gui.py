...
from cable_tester.ui.topology_panel import TopologyPanel, read_expected_mapping
from cable_tester.analysis.topology_scan import TopologyPort, classify_measurement
...
class TopologyRoutingTests(unittest.TestCase):
    ...
    def test_server_stop_waits_for_topology_cleanup(self) -> None:
        self.app.topology_scan.running = True
        with mock.patch("cable_tester.ui.gui.threading.Thread") as worker:
...
class TopologyPanelTests(unittest.TestCase):
    ...
    def test_invalid_binary_repeats_do_not_submit_a_scan(self) -> None:
        self.panel.scan_method.set("binary")
        with mock.patch("cable_tester.ui.topology_panel.messagebox.showerror") as show_error:
