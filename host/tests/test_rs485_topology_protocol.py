...
class RS485TopologyProtocolTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls._temp = tempfile.TemporaryDirectory(prefix="rs485_protocol_", dir=HOST / "tests")
        ...
        if compiler.is_zig:
            ...
            command += ["-shared", "-fPIC"]
        command += [str(HOST / "tests/firmware/rs485_topology_protocol_test.c"), "-o", str(output)]
        try:
